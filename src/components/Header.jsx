...
export default function MegaMenu3() {
  ...
  return (
    <header>
      <div className="bg-gray-600 dark:bg-dark">
          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                <nav
                  id="navbarCollapse"
                  className={`absolute right-4 top-full w-full max-w-[300px] rounded-lg bg-gray-600 px-6 py-5 shadow lg:static lg:block lg:w-full lg:max-w-full lg:shadow-none dark:bg-dark-2 lg:dark:bg-transparent ${
                    !open && "hidden"
                  }`}
                >
                  <ul className="block lg:flex">
                    <li className="relative">
                      <button
                        ...
                        className="flex w-full items-center justify-between gap-2 py-2 text-base font-medium text-gray-100 hover:text-gray-300 lg:ml-12 lg:inline-flex lg:w-auto lg:justify-center dark:text-dark-6 dark:hover:text-white"
                      >
                        Products
                        <span
                          className={`${
                      ...
                      <div
                        className={`w-full rounded-xl bg-gray-400 p-2 lg:absolute lg:left-0 lg:top-full lg:w-[630px] lg:p-8 lg:shadow-lg dark:bg-dark ${
                    ...
                    <li>
                      <a
                        href="#"
                        className="flex py-2 text-base font-medium text-gray-100 hover:text-gray-300 lg:ml-12 lg:inline-flex dark:text-dark-6 dark:hover:text-white"
                      >
                        Home
                      </a>
                    </li>
